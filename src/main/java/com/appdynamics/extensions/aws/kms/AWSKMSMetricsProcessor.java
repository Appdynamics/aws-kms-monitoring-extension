 ...
 */
public class AWSKMSMetricsProcessor implements MetricsProcessor {

    private static final String NAMESPACE = "AWS/KMS";

    private List<IncludeMetric> includeMetrics;

    private List<Dimension> dimensions;

    public AWSKMSMetricsProcessor(List<IncludeMetric> includeMetrics, List<Dimension> dimensions) {
    ...
    public List<Metric> createMetricStatsMapForUpload(NamespaceMetricStatistics namespaceMetricStats) {
        ...
        for (Dimension dimension : dimensions) {
            dimensionToMetricPathNameDictionary.put(dimension.getName(), "KeyId");
        }
